...
* Flash is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Flash is mean to act as a starting point for Android Applications.

# Flash App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-fcode.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-fcode)

This repository contains the source code for the [Flash](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.fcode).

Please see the [issues](https://github.com.fcode/com-fcode/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Flash? Ask away on the [com-fcode discussion forum](https://groups.google.com/forum/#!forum/com-fcode).

<a href="https://play.google.com/store/apps/details?id=com.fcode" alt="Download from Google Play">
...
At that point all the source files that were located in ____com.fcode__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.fcode.R__) will now be renamed
...
signed with a different key.  Manually uninstall Flash from your device and
...
Flash is a result of a template project I've developed over the years as well as
...
Flash is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.fcode/com-fcode/contributors) on
...
[pull requests](https://github.com.fcode/com-fcode/pulls).
